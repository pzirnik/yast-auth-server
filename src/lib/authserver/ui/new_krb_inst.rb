...
Do you still wish to continue?'))
    ...
    begin
      ...
      # no error reporting as it is a possible remote server
      DS389.enable_krb_schema(dir_inst)
      ...
      # Set dependency for the ds389 service
      # no error reporting, possible remote server
      DS389.set_ds389_dep(dir_inst)
